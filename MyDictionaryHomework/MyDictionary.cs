...
namespace MyDictionaryHomework
{
    class MyGenericDictionary<TKey, TValue>
    {
        ...
        public void Add(TKey key, TValue value)
        {
            ...
            // tek for döngüsü ile iki array eşitlemeyi de yapabiliriz çünkü eleman sayıları aynı
        ...
        // iki metot listelerimizi consol'da göstermemizi sağlar.
        public TKey[] Items1
        {
            get { return keyArray; }
        }
        ...
        // elemanları daha kısa listeleme yöntemi
        public void Items()
        {
            for (int i = 0; i < keyArray.Length; i++)
            {
                Console.WriteLine("Plaka No: " + keyArray[i] + " " + "\nŞehirler: " + valueArray[i]);
                Console.WriteLine("------------");
            }
        }
    }
